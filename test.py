                                ...
                                if bid_amount >= gadget["price"]:
                                    ...
                                    if token:
                                        ...
                                        if result:
                                            ...
                                            st.markdown(f"[👉Click here to complete bid .]({https://pay.pesapal.com/iframe/PesapalIframe3/Index?OrderTrackingId=a202cc85-e9d1-4b46-bf03-dc9f25a7565a})", unsafe_allow_html=True)
                                        else:
